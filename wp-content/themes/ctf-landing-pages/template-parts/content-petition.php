<?php
/**
 * Petition content partial.
 * Used by single-petition template (and other contexts) without header/footer.
 */
...
<div class="petition-template card">
    ...
    <form class="petition-form" method="post" id="petition-form">
        ...
        <input type="hidden" name="petition_title" value="<?= esc_attr($content['title']) ?>" />
        <div class="form-grid">
