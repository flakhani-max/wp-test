...
WP_OFFLOAD_MEDIA_LICENSE=$(gcloud secrets versions access latest --secret=WP_OFFLOAD_MEDIA_LICENSE --project=$PROJECT_ID 2>/dev/null || echo "")
...
WP_OFFLOAD_MEDIA_LICENSE=$WP_OFFLOAD_MEDIA_LICENSE
